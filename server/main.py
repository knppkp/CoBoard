...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://co-board-flax.vercel.app", "http://localhost:3000"],
...
def initialize_data(session: Session):
    ...
    session.bulk_insert_mappings(models.SEUser, se_users)
    
    # Insert initial data for `tag`
    tags = [
        {'tag_text': 'Portfolios', 'board': 'admission'},
        {'tag_text': 'Recommendations', 'board': 'admission'},
        {'tag_text': 'Campus lifes', 'board': 'admission'},
        {'tag_text': 'Visa advices', 'board': 'admission'},
        {'tag_text': 'Scholarships', 'board': 'admission'},
        {'tag_text': 'Exchange programs', 'board': 'admission'},
        {'tag_text': 'Requirements', 'board': 'admission'},
        {'tag_text': 'Minimum scores', 'board': 'admission'},
        {'tag_text': 'Interviews', 'board': 'admission'},
        {'tag_text': 'Course syllabus', 'board': 'admission'},
        {'tag_text': 'Locations', 'board': 'admission'},
        {'tag_text': 'Open houses', 'board': 'admission'},
        {'tag_text': 'Fees and waivers', 'board': 'admission'},
        {'tag_text': 'Contacts', 'board': 'admission'},
        {'tag_text': 'Year 1', 'board': 'classwork'},
        {'tag_text': 'Year 2', 'board': 'classwork'},
        {'tag_text': 'Year 3', 'board': 'classwork'},
        {'tag_text': 'Year 4', 'board': 'classwork'},
        {'tag_text': 'Metaverse SE', 'board': 'classwork'},
        {'tag_text': 'Artificial Intelligence', 'board': 'classwork'},
        {'tag_text': 'Industrial IOT', 'board': 'classwork'},
        {'tag_text': 'Programming', 'board': 'classwork'},
        {'tag_text': 'Math', 'board': 'classwork'},
        {'tag_text': 'Computer Science', 'board': 'classwork'},
        {'tag_text': 'Software Design', 'board': 'classwork'},
        {'tag_text': 'Hardware', 'board': 'classwork'},
        {'tag_text': 'Restaurants', 'board': 'discussion'},
        {'tag_text': 'Cafes', 'board': 'discussion'},
        {'tag_text': 'Coffees', 'board': 'discussion'},
        {'tag_text': 'Desserts', 'board': 'discussion'},
        {'tag_text': 'Cheap', 'board': 'discussion'},
        {'tag_text': 'Inside campus', 'board': 'discussion'},
        {'tag_text': 'Outside campus', 'board': 'discussion'},
        {'tag_text': 'Full-time jobs', 'board': 'discussion'},
        {'tag_text': 'Part-time jobs', 'board': 'discussion'},
        {'tag_text': 'Charitable activities', 'board': 'discussion'},
        {'tag_text': 'Party hunting', 'board': 'discussion'},
        {'tag_text': 'Games', 'board': 'discussion'},
        {'tag_text': 'Memes', 'board': 'discussion'},
        {'tag_text': 'Meetups', 'board': 'discussion'},
        {'tag_text': 'Hackathons', 'board': 'discussion'},
        {'tag_text': 'Transportations', 'board': 'discussion'},
        {'tag_text': 'Book recommendations', 'board': 'discussion'},
        {'tag_text': 'Housing', 'board': 'discussion'},
        {'tag_text': 'Events', 'board': 'discussion'},
        {'tag_text': 'Festivals', 'board': 'discussion'},
        {'tag_text': 'Short notes', 'board': 'education'},
        {'tag_text': 'Slides', 'board': 'education'},
        {'tag_text': 'Course materials', 'board': 'education'},
        {'tag_text': 'Reviews', 'board': 'education'},
        {'tag_text': 'Recordings', 'board': 'education'},
        {'tag_text': 'Assignments', 'board': 'education'},
        {'tag_text': 'Projects', 'board': 'education'},
        {'tag_text': 'Tutoring', 'board': 'education'},
        {'tag_text': 'Homework', 'board': 'education'},
        {'tag_text': 'Practice tests', 'board': 'education'},
        {'tag_text': 'Study plans', 'board': 'education'},
        {'tag_text': 'Research sources', 'board': 'education'},
        {'tag_text': 'Exam tips', 'board': 'education'},
        {'tag_text': 'Online Tools', 'board': 'education'},
        {'tag_text': 'Free courses', 'board': 'education'},
        {'tag_text': 'Meetups', 'board': 'alumni'},
        {'tag_text': 'Job recommendations', 'board': 'alumni'},
        {'tag_text': 'Job reviews', 'board': 'alumni'},
        {'tag_text': 'Contacts', 'board': 'alumni'},
        {'tag_text': 'Job markets', 'board': 'alumni'},
        {'tag_text': 'Further educations', 'board': 'alumni'},
        {'tag_text': 'University experience', 'board': 'alumni'},
        {'tag_text': 'Career paths', 'board': 'alumni'},
        {'tag_text': 'Networking', 'board': 'alumni'},
        {'tag_text': 'Advices', 'board': 'alumni'},
    ]
    session.bulk_insert_mappings(models.Tag, tags)
